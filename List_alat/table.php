  ...
  <body>
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link active dropdown-toggle" href="#" id="navbarDropdownAlatn" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    Alat
                                </a>
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdownAlat">
                                    <li><a class="dropdown-item active" href="#">List Alat</a></li>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdownBahan">
                                    <li><a class="dropdown-item" href="../List_bahan/table.html">List Alat</a></li>
    ...
    <thead>
        <tr>
            ...
            <th scope="col">Spesifikasi Volume</th>
            <th scope="col">Keterangan</th> <!-- Closed the opening tag for th -->
        </tr>
    </thead>
    <tbody>
        <?php
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "<td>" . $row['stok_alat'] . "</td>";
            echo "<td>" . $row['spesifikasi_vol'] . "</td>";

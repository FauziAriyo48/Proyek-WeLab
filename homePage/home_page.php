                      ...
                      <ul class="navbar-nav">
                          ...
                          <li class="nav-item dropdown">
                              ...
                              <ul class="dropdown-menu" aria-labelledby="navbarDropdownBahan">
                                  <li><a class="dropdown-item" href="../login/index.php">List Bahan</a></li>
                                  <li><a class="dropdown-item" href="../login/index.php">Pemesanan</a></li>
                              </ul>
                          </li>
                          <li class="nav-item dropdown">
                              ...
                              <ul class="dropdown-menu" aria-labelledby="navbarDropdownAlat">
                                  <li><a class="dropdown-item" href="../login/index.php">List Alat</a></li>
                                  <li><a class="dropdown-item" href="../login/index.php">Pemesanan</a></li>
                              </ul>
                          </li>
                          <li class="nav-item">
                              <a class="nav-link" href="../status_pemesanan/index.php">Status Pemesanan</a>
                          </li>
                          <li class="nav-item log-in">
                              <a class="nav-link log" href="../login/index.php"><span class="login">Login</span></a>
                          </li>
                      </ul>
                  </div>
              </div>
